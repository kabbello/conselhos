...
<div class="page">
    ...
    <div class="header">
        <div class="municipio-nome">
            Prefeitura Municipal de {{ $reuniao->conselho->municipio->nome ?? '' }}
        </div>
    ...
    <div class="presenca-section">
        ...
        <table class="presenca-table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center">Nenhum membro registrado na composição.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="mt-4" style="font-size: 8.5pt; color: #555;">
            Total de membros na composição: {{ $composicoes->count() }}
        </div>
        @endif
    </div>
